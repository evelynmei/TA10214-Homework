...
//		int total = 256559;
//		int dayPrime = total / 24 / 60 / 60 ;
//		int hourPrime = ( total % ( 24 * 60 * 60) ) / (60 * 60);
//		int minutePrime = ( total % (24 * 60 * 60) % ( 60 * 60) ) / 60;
//		int secondPrime = ( ( total % (24 * 60 * 60) % ( 60 * 60) ) ) % 60;
//		System.out.printf( "%d天 %d時 %d分 %d秒%n", dayPrime, hourPrime, minutePrime, secondPrime);
		...
		// 某人在銀行存入150萬,銀行利率為2%,如果每年利息都繼續存入銀行,請用程式計算10年後,本金加利息共有多少錢(用複利計算,公式: 本利和=
		// 本金*(1+利率)^2)
		 1500000 * (1 + 0.02)
		...
		// '5'表示為char, 但與前面的int 5相加時, 較小的char晉升為int, 在ASCII中char 5的int為53, 故5+53=58
		System.out.println(5 + '5');
		// int 5串接string 5, 較小的int 5晉升為string
		System.out.println(5 + "5");
	}
